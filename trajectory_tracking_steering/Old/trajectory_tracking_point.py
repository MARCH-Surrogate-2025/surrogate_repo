...
target_x = 6
target_y = 2
sphere_prim = UsdGeom.Sphere.Define(stage, "/World/marker_sphere")
sphere_prim.AddTranslateOp().Set(Gf.Vec3f(target_x, target_y, 0))  # 살짝 지면 위
sphere_prim.AddScaleOp().Set(Gf.Vec3f(0.05, 0.05, 0.05))  # 점처럼 작게
...
def set_goal():
    ...
    target_x = 12
    target_y = 0
    sphere_prim1 = UsdGeom.Sphere.Define(stage, "/World/marker_sphere1")
    sphere_prim1.AddTranslateOp().Set(Gf.Vec3f(target_x, target_y, 0))  # 살짝 지면 위
    sphere_prim1.AddScaleOp().Set(Gf.Vec3f(0.05, 0.05, 0.05))  # 점처럼 작게
...
# plt.savefig("/home/user404/Desktop/plot_roll,steering.png")
# print("파일 저장 완료")
...
plt.grid(True)
plt.savefig("/home/user404/Desktop/trajectory_xy.png") 
print("파일 저장 완료")
time.sleep(1)
